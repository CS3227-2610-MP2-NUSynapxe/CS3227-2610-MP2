...
- [x] 1.2 Add receipt queries plus service-layer composition for inclusive date ranges and patient, Doctor, and payment-method filters.
...
- [x] 3.1 Add persistence and service tests for date ranges, filters, aggregation, and exclusion of unsuccessful activity.
