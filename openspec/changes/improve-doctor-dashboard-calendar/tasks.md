...
- [ ] 7.5 Update the User Guide and Developer Guide for the Calendar/Agenda names, date-based Agenda navigation, responsive toolbar, and full-height Patient Directory table; run focused tests, the full quality gate, strict OpenSpec validation, and `git diff --check`.
