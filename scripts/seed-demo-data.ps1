...
Write-Host '  Doctor       : ada / ada1234!'
Write-Host '  Doctor       : grace / grace123!'
Write-Host '  Receptionist : reception / recept123!'
Write-Host ''
Write-Host 'The seed includes 18 patients, a 22-day appointment window, and historical clinical records.'
